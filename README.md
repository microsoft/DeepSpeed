...
## Windows
Many DeepSpeed features are supported on Windows for both training and inference. The features that are currently not supported are async io (AIO) and GDS (which does not support Windows).
