...
def parse_arguments():
    ...
    parser.add_argument('--io_dir',
                        required=True,
                        type=str,
                        help='Directory in which to perform I/O tests. Normally where (NVMe) device is mounted.')
    ...
    parser.add_argument('--no_sudo',
                        action='store_true',
                        help='Run without sudo access. Page cache will not be flushed and reported read speeds may be higher than actual.')
