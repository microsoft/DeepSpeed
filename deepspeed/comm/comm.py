...
from deepspeed.utils import timer, get_logger_v2_name
...
@timed_op
def barrier(group=None, prof=False, log_name='barrier', debug=get_logger_v2_name()):
    global cdb
    return cdb.barrier()
