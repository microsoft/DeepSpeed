...
class OnebitLamb(torch.optim.Optimizer):
    ...
    def __init__(self,
        ...
        if self.comm_backend_name == 'nccl':
            ...
            assert (TORCH_MAJOR == 1 and TORCH_MINOR >= 8) or TORCH_MAJOR >= 2, "Please use torch 1.8 or greater to enable NCCL backend in 1-bit Adam. Alternatively, please specify 'mpi' as the 'comm_backend_name' in config file to proceed with the MPI backend"
