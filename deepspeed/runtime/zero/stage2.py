...
class FP16_DeepSpeedZeroOptimizer(object):
    ...
    def __init__(self,
        ...
        if self.reduce_scatter:
            assert self.communication_data_type is not None, "communication_data_type is not yet supported with ZeRO-2 with reduce scatter enabled"
    ...
    def allreduce_bucket(self,
        ...
        if communication_data_type is not None:
