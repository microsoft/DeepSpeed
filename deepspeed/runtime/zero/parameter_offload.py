...
class DeepSpeedZeRoOffload(object):
    ...
    def __init__(self,
        ...
        self.__allgather_stream = None if get_accelerator().is_synchronized_device() else get_accelerator().Stream() if overlap_comm else get_accelerator().default_stream()
