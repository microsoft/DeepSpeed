...
# Stage 1/2 - temporarily move params to cpu while zero creates its partitions
ZERO_OPTIMIZATION_MOVE_PARAMS_TO_CPU_DURING_INIT = "move_params_to_cpu_during_init"
ZERO_OPTIMIZATION_MOVE_PARAMS_TO_CPU_DURING_INIT_DEFAULT = True
