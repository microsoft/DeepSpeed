...
# Enable grad hooks to reduce grads during backward pass, must be enabled for
# grad partitioning (ZeRO-2) but optional with optimizer partitioning (ZeRO-1).
ZERO_OPTIMIZATION_GRAD_HOOKS = "grad_hooks"
ZERO_OPTIMIZATION_GRAD_HOOKS_DEFAULT = True
...
ZERO_OPTIMIZATION_DEFAULT = {
    ...
    ZERO_OPTIMIZATION_OFFLOAD_PARAM: ZERO_OPTIMIZATION_OFFLOAD_PARAM_DEFAULT,
    ZERO_OPTIMIZATION_OFFLOAD_OPTIMIZER: ZERO_OPTIMIZATION_OFFLOAD_OPTIMIZER_DEFAULT,
    ZERO_OPTIMIZATION_SUB_GROUP_SIZE: ZERO_OPTIMIZATION_SUB_GROUP_SIZE_DEFAULT,
    ZERO_OPTIMIZATION_MAX_LIVE_PARAMETERS: ZERO_OPTIMIZATION_MAX_LIVE_PARAMETERS_DEFAULT,
    ZERO_OPTIMIZATION_MAX_REUSE_DISTANCE: ZERO_OPTIMIZATION_MAX_REUSE_DISTANCE_DEFAULT,
    ...
    ZERO_OPTIMIZATION_GRAD_HOOKS: ZERO_OPTIMIZATION_GRAD_HOOKS_DEFAULT
}
