...
from deepspeed.runtime.comm.coalesced_collectives import reduce_scatter_coalesced_for_subgroup_order
...
class ParoIGGOptimizer(ZeROOptimizer):
    """
    ...
    1. params 节点内shard 节点间replica
    2. grads, optimizer 进行全局shard
    ...
    def __init__(self,
        ...
        see_memory_usage("Paro IGG initialize beginning", force=True)
    ...
    def _setup_for_real_optimizer(self):
        ...
        for param in all_params:
            self.__param_id_to_grad_partition[param.ds_id] = self.grad_partitions_flat_buffer.narrow(
                0, offset, param.zero4_os_partition_numel())
            offset += param.zero4_os_partition_numel()
