...
class PartitionedParameterCoordinator:
    ...
    def __all_gather_params(self, params: Set[Parameter]) -> None:
        ...
        if partitioned_params:
            ...
            # Release swap buffers for persisted params on nvme since they wil never be partitioned or evicted from GPU
            swap_persisted_params = [p for p in partitioned_params if p.ds_persist and p.ds_tensor.final_location == OFFLOAD_NVME_DEVICE]
