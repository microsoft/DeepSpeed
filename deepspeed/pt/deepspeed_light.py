...
class DeepSpeedLight(Module):
    ...
    def _configure_basic_optimizer(self, model_parameters):
        ...
        if self.fp16_enabled() and 'max_grad_norm' in optimizer_parameters.keys():
            warnings.warn("'max_grad_norm' is not supported as an optimizer parameter, please switch to using the deepspeed parameter 'gradient_clipping' see: https://www.deepspeed.ai/docs/config-json/#gradient-clipping for more details")
