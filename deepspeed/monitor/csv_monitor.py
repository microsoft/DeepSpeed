...
class csvMonitor(Monitor):
    def __init__(self, monitor_config):
        ...
        self.filenames = []
        self.enabled = monitor_config.csv_monitor.enabled
        self.output_path = monitor_config.csv_monitor.output_path
        self.job_name = monitor_config.csv_monitor.job_name
