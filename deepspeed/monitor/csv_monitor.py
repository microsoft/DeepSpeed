...
class csvMonitor(Monitor):
    def __init__(self, csv_monitor_config):
        super().__init__(csv_monitor_config)
        self.filenames = []
        self.enabled = csv_monitor_config.enabled
        self.output_path = csv_monitor_config.output_path
        self.job_name = csv_monitor_config.job_name
