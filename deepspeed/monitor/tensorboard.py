...
class TensorBoardMonitor(Monitor):
    def __init__(self, monitor_config):
        ...
        self.enabled = monitor_config.tensorboard.enabled
        self.output_path = monitor_config.tensorboard.output_path
        self.job_name = monitor_config.tensorboard.job_name
