...
//      Read  Global: Each Warp/ThreadBlock: 32 threads_per_warp * 8 float_per_thread (256bit) ->
//      256 float per warp Write Global: Each Warp/ThreadBlock: 32 threads_per_warp * 8
//      half_per_thread  (128bit) -> 256 half  per warp
