                                ...
                                int Split_K)
{
    ...
    cudaFuncSetAttribute(QUANT_GEMM_Kernel<TilingConfig, OutputDataType>,
                         ...
                         SHMEM_SZ);
    int dimN = N_Global / TilingConfig::TILE_N;
...
/*
 *half* Reduction_Workspace:  1. Requiring an extra memory space in device memory for un-reducted
 *intermediate output tensors
 *                            2. Reduction_Workspace_Size = Split_K * M_Global * N_Global *
 *sizeof(fp32)
 */
    ...
    if (Split_K == 1) {
        ...
        switch (N_Global) {
            case 8:
                ...
                break;
            case 16:
                Kernel_QuantGEMM_Ex<TilingConfig<4, 1, 2>, float>(stream,
                                                                  Weight1,
                                                                  Weight2,
                                                                  Scales,
                                                                  QUANT_GROUP_SIZE_DIVIDED_BY_64,
                ...
                break;
            case 32:
                Kernel_QuantGEMM_Ex<TilingConfig<4, 1, 4>, float>(stream,
                                                                  Weight1,
                                                                  Weight2,
                                                                  Scales,
                                                                  QUANT_GROUP_SIZE_DIVIDED_BY_64,
