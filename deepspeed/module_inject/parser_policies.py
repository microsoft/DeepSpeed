...
class ParserPolicies():
    parser_policy_map = dict(
        ...
        clip=dict(CLIPEncoderLayer=(
            "mlp.fc2",
            "self_attn.out_proj",
        ),
                  ),
        codegen=dict(CodeGenBlock=(
            "mlp.fc_out",
            "attn.out_proj",
        ),
                     ),
        conditionaldetr=dict(
        ...
        data2vecaudio=dict(Data2VecAudioEncoderLayer=(
        ...
        data2vecvision=dict(Data2VecVisionLayer=(
            "output.dense",
            "intermediate.dense",
        ),
                            ),
        ...
        distilbert=dict(TransformerBlock=(
            "attention.out_lin",
            "ffn.lin2",
        ),
                        ),
        donutswin=dict(DonutSwinLayer=(
            "intermediate.dense",
            "output.dense",
        ),
                       ),
        dpt=dict(DPTViTLayer=(
            "intermediate.dense",
            "output.dense",
        ),
                 ),
        ...
        gptneox=dict(GPTNeoXLayer=(
            "attention.dense",
            "mlp.dense_4h_to_h",
        ),
                     ),
        gptneoxjapanese=dict(GPTNeoXJapaneseLayer=(
            "attention.dense",
            "mlp.dense_4h_to_h",
        ),
                             ),
        ...
        megatronbert=dict(MegatronBertLayer=(
            "output.dense",
            "intermediate.dense",
        ),
                          ),
        ...
        opt=dict(OPTDecoderLayer=(
            "self_attn.out_proj",
            ".fc2",
        ),
                 ),
        owlvit=dict(OwlViTEncoderLayer=(
            "mlp.fc2",
            "self_attn.out_proj",
        ),
                    ),
        ...
        pegasusx=dict(PegasusXDecoderLayer=(
            ".fc2",
            "encoder_attn.out_proj",
            "self_attn.out_proj",
        ),
        ...
        prophetnet=dict(
            ...
            ProphetNetDecoderLayer=(
                "self_attn.relative_pos_embeddings",
                "cross_attn.out_proj",
                "feed_forward.output",
            ),
        ),
        ...
        speechtotext2=dict(Speech2Text2DecoderLayer=(
            "encoder_attn.out_proj",
            ".fc2",
            "self_attn.out_proj",
        ),
        ...
        trajectorytransformer=dict(Block=(
            ".l2",
            "attn.proj",
        ),
                                   ),
        trocr=dict(TrOCRDecoderLayer=(
            ".fc2",
            "encoder_attn.out_proj",
            "self_attn.out_proj",
        ),
        ...
        vitmae=dict(ViTMAELayer=(
            "intermediate.dense",
            "output.dense",
        ),
                    ),
        vitmsn=dict(ViTMSNLayer=(
            "output.dense",
            "intermediate.dense",
        ),
                    ),
        ...
        wav2vec2conformer=dict(Wav2Vec2ConformerEncoderLayer=(
        ...
        xclip=dict(
            PromptGeneratorLayer=("cross_attn.proj",
                                  ),
            XCLIPVisionEncoderLayer=(
                ".message_fc",
                "message_attn.out_proj",
                "mlp.fc2",
                "self_attn.out_proj",
            ),
            XCLIPEncoderLayer=(
        ...
        xlmprophetnet=dict(
            XLMProphetNetEncoderLayer=(
                "self_attn.out_proj",
                "feed_forward.output",
            ),
            XLMProphetNetDecoderLayer=(
                "cross_attn.out_proj",
                "self_attn.relative_pos_embeddings",
                "feed_forward.output",
            ),
        ...
        xlmrobertaxl=dict(XLMRobertaXLLayer=(
            "intermediate.dense",
            "output.dense",
        ),
                          ),
