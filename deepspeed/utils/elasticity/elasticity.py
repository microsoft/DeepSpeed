...
hcn_list = [1, 2, 4, 6, 12, 24, 36,
        48, 60, 120, 180, 240, 360, 720, 840,
        1260, 1680, 2520, 5040, 7560, 10080,
        15120, 20160, 25200, 27720, 45360, 50400,
...
def small_test():
    ...
    print(f"Final Batch: {final_batch}, Micro batches {micro_batches}, compatible gpus {compatible_gpu_counts} total gpus {len(compatible_gpu_counts)}")
