...
class DeepSpeedDiffusersTransformerBlock(nn.Module):
    ...
    def forward(self, hidden_states, context=None, timestep=None):
        ...
        out_norm_2, out_attn_1 = self.transformer_cuda_module.layer_norm_res_store(out_attn_1,
                                                                 self.attn_1_bias,
                                                                 hidden_states,
                                                                 self.norm2_g,
                                                                 self.norm2_b,
        ...
        out_norm_3, out_attn_2 = self.transformer_cuda_module.layer_norm_res_store(out_attn_2,
                                                                 self.attn_2_bias,
                                                                 out_attn_1,
                                                                 self.norm3_g,
                                                                 self.norm3_b,
