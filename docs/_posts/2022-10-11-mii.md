...
MII supported models can be easily deployed with just a few lines of code in two different ways as shown in *Figure A*. Learn more about getting started with deploying MII via the [MII getting started guide](https://github.com/microsoft/deepspeed-mii#getting-started-with-mii).
...
More details about MII local deployments can be found in the [MII local deployment documentation](https://github.com/microsoft/deepspeed-mii#deploying-with-mii-locally).
...
More details about MII AML deployments can be found in the [MII AML deployment documentation](https://github.com/microsoft/deepspeed-mii#deploying-with-mii-aml).
