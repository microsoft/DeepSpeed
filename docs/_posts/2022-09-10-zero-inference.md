...
The first optimization involves overlapping the fetch of a particular layer with the computation of an earlier layer, a.k.a., layer prefetching. With layer prefetching, ZeRO-Inference can hide portions of the transfer latency of prefetched layers. Layer prefetching is especially effective for computations on long sequence lengths and/or large batch sizes.
