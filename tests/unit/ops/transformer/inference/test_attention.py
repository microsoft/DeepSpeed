...
def test_attention(Z, H, N_CTX, D_HEAD, causal, dtype=torch.float16):
    ...
    tri_out = compute_attention(qkv, input_mask=mask, layer_past=None, alibi=None, scale=sm_scale, head_size=D_HEAD, triangular=False, use_cuda_flash=False, use_triton_flash=False, use_ds_attention=False)
