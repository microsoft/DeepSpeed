...
@pytest.mark.parametrize('num_ranks,batch,micro_batch,gas,success', [(2, 32, 16, 1, True), (2, 32, 8, 2, True), (2, 33, 17, 2, False), (2, 32, 18, 1, False)])
def test_batch_config(num_ranks, batch, micro_batch, gas, success):
    ...
    def _test_batch_config(num_ranks, batch, micro_batch, gas, success):
        ...
        ds_batch_config = 'ds_batch_config.json'
